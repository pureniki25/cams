...
public enum  RepayPlanItemTypeEnum implements IEnum {
    ...
    PRINCIPAL(10,"本金","639871ec-9876-4b42-949c-418ab5c685ca"),
    INTEREST(20,"利息","fc86e498-0159-43d3-9ebc-e4dfa57c562b"),
    ...
    OVER_DUE_AMONT(60,"滞纳金","097e7d7b-9671-4027-a329-b07375092028"),
    PENALTY_AMONT(70,"违约金","dba7c05b-95e5-41bb-96e5-44d34d3de2dc"),
    ...
    RepayPlanItemTypeEnum(final int value, final String desc,final String uuid) {
        this.value = value;
        this.desc = desc;
        this.uuid = uuid;
    }
    ...
    public static String nameOf(Integer key){
        for(RepayPlanItemTypeEnum d : RepayPlanItemTypeEnum.values()){
    ...
    public static RepayPlanItemTypeEnum getByKey(Integer key){
        for(RepayPlanItemTypeEnum d : RepayPlanItemTypeEnum.values()){
            if(d.value.equals(key)){
                return d;
            }
