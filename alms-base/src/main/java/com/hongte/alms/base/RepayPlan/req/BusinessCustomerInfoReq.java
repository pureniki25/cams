...
public class BusinessCustomerInfoReq {
    ...
    @NotNull(message = "BusinessCustomerInfoReq 是否主借款人(ismainCustomer)不能为空")
    private Integer ismainCustomer;
    /**
     *  客户名称，个人则填个人名称，企业则填企业名称 
     */
    @ApiModelProperty(required= true,value = " 客户名称，个人则填个人名称，企业则填企业名称 ")
    @NotNull(message = "BusinessCustomerInfoReq 客户名称(customerName)不能为空")
    ...
    @NotNull(message = "BusinessCustomerInfoReq 客户类型(customerType)不能为空")
    ...
    @NotNull(message = "BusinessCustomerInfoReq 客户身份证唯一标识(identifyCard)不能为空")
    private String identifyCard;
    /**
     *  客户接收短信的手机号码，当客户类型为企业时，此字段保存联系人手机号码 
     */
    @ApiModelProperty(required= true,value = " 客户接收短信的手机号码，当客户类型为企业时，此字段保存联系人手机号码 ")
    @NotNull(message = "BusinessCustomerInfoReq 客户接收短信的手机号码(phoneNumber)不能为空")
