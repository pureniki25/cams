...
@ApiModel
@TableName("tb_jt_dat")
public class JtDat extends Model<JtDat> {
     ...
     * 标志
     */
	@ApiModelProperty(required= true,value = "标志")
	private String uuid;
    /**
     * 公司名称
     */
     ...
     */
	@TableField("jt_type")
	@ApiModelProperty(required= true,value = "1：工资 2：社保  3:资产")
	private String jtType;
    /**
     * 计提日期
     */
	@TableField("open_date")
	@ApiModelProperty(required= true,value = "计提日期")
     ...
     * 计提入账日期
     */
	@TableField("ru_zhang_ri_qi")
	@ApiModelProperty(required= true,value = "计提入账日期")
	private String ruZhangRiQi;
    /**
     * 预计年限
     */
	@TableField("yu_ji_nian_xian")
	@ApiModelProperty(required= true,value = "预计年限")
	private String yuJiNianXian;
    /**
     * 累计折旧
     */
	@TableField("lei_ji_zhe_jiu")
	@ApiModelProperty(required= true,value = "累计折旧")
	private String leiJiZheJiu;
    /**
     * 折旧后净额
     */
	@TableField("jing_e")
	@ApiModelProperty(required= true,value = "折旧后净额")
	private String jingE;
    /**
     * 1：已处理 0：待处理
     */
	@TableField("is_deal")
	@ApiModelProperty(required= true,value = "1：已处理 0：待处理")
	...
	public void setRuZhangRiQi(String ruZhangRiQi) {
		this.ruZhangRiQi = ruZhangRiQi;
	}

	public String getYuJiNianXian() {
		return yuJiNianXian;
	}

	public void setYuJiNianXian(String yuJiNianXian) {
		this.yuJiNianXian = yuJiNianXian;
	}
	...
	public void setJingE(String jingE) {
		this.jingE = jingE;
	}
	...
	public String toString() {
		return "JtDat{" +
			...
			", qiJian=" + qiJian +
			", pingZhengRiQi=" + pingZhengRiQi +
			", pingZhengZi=" + pingZhengZi +
			", pingZhengHao=" + pingZhengHao +
			", zhaiYao=" + zhaiYao +
			", keMuDaiMa=" + keMuDaiMa +
			", huoBiDaiMa=" + huoBiDaiMa +
			", huiLv=" + huiLv +
			...
			", zhiDanRen=" + zhiDanRen +
			", shenHeRen=" + shenHeRen +
			", guoZhangRen=" + guoZhangRen +
			", fuDanJuShu=" + fuDanJuShu +
			", shiFouYiGuoZhang=" + shiFouYiGuoZhang +
			", moBan=" + moBan +
			", hangHao=" + hangHao +
			", danWei=" + danWei +
			", buMen=" + buMen +
			...
			", tongJi=" + tongJi +
			", xiangMu=" + xiangMu +
			", fuKuanFangFa=" + fuKuanFangFa +
			", piaoJuHao=" + piaoJuHao +
			", yuanBiFuKuanJinE=" + yuanBiFuKuanJinE +
			", pingZhengLaiYuan=" + pingZhengLaiYuan +
			", laiYuanPingZheng=" + laiYuanPingZheng +
			", daiDaYin=" + daiDaYin +
			", zuoFeiBiaoZhi=" + zuoFeiBiaoZhi +
			", cuoWuBiaoZhi=" + cuoWuBiaoZhi +
			", pingZhengCeHao=" + pingZhengCeHao +
			", chuNaRen=" + chuNaRen +
			", ruZhangRiQi=" + ruZhangRiQi +
			", yuJiNianXian=" + yuJiNianXian +
