...
public class ProjExtRateReq {
    ...
    public static void main(String[] args) {
        ...
        ProjExtRateReq  extRateReq = new ProjExtRateReq();


        extRateReq.setRateType(70);//费率类型
        extRateReq.setRateValue(new BigDecimal("0.04"));//费率值
        extRateReq.setCalcWay(1);//费用计算方式
        extRateReq.setFeeId("79069922-e13a-4229-8656-2a1e19b44879");
        extRateReq.setPeriod(1);
...
//        private Integer period;
         ...
         String jsonStr = JSON.toJSONString(extRateReq);
