...
public class RepaymentProjPlanListDetail extends Model<RepaymentProjPlanListDetail> {
	...
	public RepaymentProjPlanListDetail(RepaymentProjPlanListDetailBak pld) {
		...
		setPlateType(pld.getPlateType());
		setProjFactAmount(pld.getProjFactAmount());
		setProjPlanAmount(pld.getProjPlanAmount());
		setProjPlanDetailId(pld.getProjPlanDetailId());
		setProjPlanListId(pld.getProjPlanListId());
