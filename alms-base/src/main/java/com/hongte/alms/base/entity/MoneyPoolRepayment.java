...
public class MoneyPoolRepayment extends Model<MoneyPoolRepayment> {
	...
	public String toString() {
		return "MoneyPoolRepayment{" + ", id=" + id + ", moneyPoolId=" + moneyPoolId + ", xdPoolId=" + xdPoolId
				+ ", xdMatchingId=" + xdMatchingId + ", planListId=" + planListId + ", operateId=" + operateId
				+ ", operateName=" + operateName + ", claimDate=" + claimDate + ", state=" + state + ", incomeType="
				+ incomeType + ", bankAccount=" + bankAccount + ", tradeType=" + tradeType + ", tradePlace="
				+ tradePlace + ", factTransferName=" + factTransferName + ", remark=" + remark + ", poolList="
				+ poolList + ", certificatePictureUrl=" + certificatePictureUrl + ", isFinanceMatch=" + isFinanceMatch
				+ ", createUser=" + createUser + ", createTime=" + createTime + ", updateUser=" + updateUser
				+ ", updateTime=" + updateTime + ", isDeleted=" + isDeleted + ", deleteUser=" + deleteUser
				+ ", deleteTime=" + deleteTime + ", accountMoney=" + accountMoney + ", tradeDate=" + tradeDate
				+ ", createUserRole=" + createUserRole + ", originalBusinessId=" + originalBusinessId + ", afterId="
				+ afterId + "}";
	}
	...
	public void update(RepaymentRegisterInfoDTO repayInfo) {
		...
		if (this.state.equals(RepayRegisterFinanceStatus.还款登记被拒绝.toString())
				...
				|| this.state.equals(RepayRegisterFinanceStatus.还款登记被财务拒绝.toString()
				)) {
