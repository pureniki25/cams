 ...
 */
@ApiModel
@TableName("tb_biz_output_plan")
public class BizOutputPlan extends Model<BizOutputPlan> {
	...
	public String toString() {
		return "BizOutputPlan{" +
			...
			", bankCity=" + bankCity +
			", remark=" + remark +
			", creditorIdPlatformUserId=" + creditorIdPlatformUserId +
