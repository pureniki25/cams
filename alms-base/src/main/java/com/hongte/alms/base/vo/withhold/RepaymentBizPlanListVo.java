 ...
 */
@ApiModel
public class RepaymentBizPlanListVo extends Model<RepaymentBizPlanListVo> {
	 ...
	 * 
	 */
	public RepaymentBizPlanListVo(RepaymentBizPlanList pl) {
		super();
