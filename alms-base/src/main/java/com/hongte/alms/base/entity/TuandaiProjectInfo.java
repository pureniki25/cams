...
public class TuandaiProjectInfo extends Model<TuandaiProjectInfo> {
	...
	public String toString() {
		return "TuandaiProjectInfo{" +
				...
				", accounterConfirmUserId=" + accounterConfirmUserId +
				", accounterConfirmUserName=" + accounterConfirmUserName +
				", tdLoanTime=" + tdLoanTime +
				", tdLoanMoney=" + tdLoanMoney +
				", extendFlag=" + extendFlag +
				", catsedAmount=" + catsedAmount +
