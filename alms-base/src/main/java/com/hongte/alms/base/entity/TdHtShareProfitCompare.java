 ...
 */
@ApiModel
@TableName("tb_td_ht_share_profit_compare")
public class TdHtShareProfitCompare extends Model<TdHtShareProfitCompare> {
     ...
     */
	@TableField("due_date")
	@ApiModelProperty(required= true,value = "ht应还日期")
