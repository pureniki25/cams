 ...
 */
@ApiModel
@TableName("tb_repayment_platform_list_borrower")
public class RepaymentPlatformListBorrower extends Model<RepaymentPlatformListBorrower> {
	...
	public String toString() {
		return "RepaymentPlatformListBorrower{" +
			", id=" + id +
			", projectId=" + projectId +
			", period=" + period +
