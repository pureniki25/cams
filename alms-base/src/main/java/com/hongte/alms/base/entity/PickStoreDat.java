...
public class PickStoreDat extends Model<PickStoreDat> {
     ...
     * 类型 1: 领料 2:入库
     */
	@ApiModelProperty(required= true,value = "类型 1: 领料 2:入库")
	@TableField("pick_store_type")
	private Integer pickStoreType;
    /**
     * 公司名称
     */
	...
	public void setPickStoreId(String pickStoreId) {
	...
	public Integer getPickStoreType() {
		return pickStoreType;
	}

	public void setPickStoreType(Integer pickStoreType) {
		this.pickStoreType = pickStoreType;
	}
