...
@Data
@ApiModel
@TableName("tb_fee_dat")
public class FeeDat extends Model<FeeDat> {
   ...
   /**
	...
	@ApiModelProperty(required= true,value = "费用单ID")
	private Integer id;
    /**
     * uuid
     */
     ...
     */
	@TableField("fee_type")
	@ApiModelProperty(required= true,value = "1：费用 2：现金支付")
	private String feeType;
    /**
     * 抵扣类型 !:待抵扣 2:可抵扣 3:不能抵扣
     */
	@TableField("deduction_type")
	@ApiModelProperty(required= true,value = "抵扣类型 !:待抵扣 2:可抵扣 3:不能抵扣")
     ...
     * 本地税额
     */
	@TableField("local_tax")
	@ApiModelProperty(required= true,value = "本地税额")
