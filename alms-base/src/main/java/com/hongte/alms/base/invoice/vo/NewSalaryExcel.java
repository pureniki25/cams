...
@ExcelTarget("NewSalaryExcel")
@Data
public class NewSalaryExcel implements Serializable {
     ...
     * 所得期间起
     */
	@Excel(name="税款所属期起" , orderNum = "3")
	private String suoDeQiJianQi;
    /**
     * 所得期间止
     */
	@Excel(name="税款所属期止" , orderNum = "4")
     ...
     * 基本养老保险
     */
	@Excel(name="本期基本养老保险费" , orderNum = "6")
	private String jiBenYangLaoBaoXian;
    /**
     * 基本医疗保险
     */
	@Excel(name="本期基本医疗保险费" , orderNum = "7")
	private String jiBenYiLiaoBaoXian;
    /**
     * 失业保险
     */
	@Excel(name="本期失业保险费" , orderNum = "8")
	private String shiYeBaoXian;
    /**
     * 住房公积金
     */
	@Excel(name="本期住房公积金" , orderNum = "9")
     ...
     * 企业年金
     */
	@Excel(name="本期企业(职业)年金" , orderNum = "15")
	private String qiYeNianJin;
    /**
     * 商业健康保险
     */
	@Excel(name="本期商业健康保险费" , orderNum = "16")
	private String shangYeJianKangBaoXian;
    /**
     * 税延养老保险
     */
	@Excel(name="本期税延养老保险费" , orderNum = "17")
	private String shuiYanYangLaoBaoXian;
    /**
     * 其他
     */
	@Excel(name="本期其他扣除(其他)" , orderNum = "18")
	private String qiTa;
    /**
     * 准予扣除的捐赠额
     */
	@Excel(name="累计准予扣除的捐赠" , orderNum = "19")
	private String zhunYuKouChuJuanZengKuan;
    /**
     * 税前扣除项目合计
     */
	@Excel(name="累计减免税额" , orderNum = "20")
     ...
     * 已扣缴税额
     */
	@Excel(name="累计已预缴税额" , orderNum = "23")
	private String yiKouJiaoShuiE;
	
    /**
     * 累计应补(退)税额
     */
	@Excel(name="累计应补(退)税额" , orderNum = "24")
	private String benQiShuiE;
