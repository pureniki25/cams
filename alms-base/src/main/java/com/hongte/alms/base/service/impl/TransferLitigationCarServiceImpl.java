...
import com.hongte.alms.base.mapper.TransferLitigationCarMapper;
 ...
 * @since 2018-03-07
 */
@Service("TransfLitigationCarService")
public class TransferLitigationCarServiceImpl extends
		BaseServiceImpl<TransferLitigationCarMapper, TransferLitigationCar> implements TransferLitigationCarService {

	private static final Logger LOG = LoggerFactory.getLogger(TransferLitigationCarServiceImpl.class);
	...
	public void saveCarProcessApprovalResult(ProcessLogReq req, String sendUrl) {
		try {
			...
			List<TransferLitigationCar> cars = this.selectList(new EntityWrapper<TransferLitigationCar>()
