...
public class VersionAdapter {
	...
	/*Dservice="1"*/
	final String ALMS_CORE_SERVICE = "(prdbug)1108 16:50" ;
	final String ALMS_FINANCE_SERVICE = "(prdbug)1027 11:30" ;
	final String ALMS_OPEN_SERVICE = "(prdbug)1026 20:35" ;
	final String ALMS_PLATREPAY_SERVICE = "(prdbug)1108 16:50" ;
	final String ALMS_SCHEDULED_SERVICE = "(prdbug)1108 16:50" ;

	final String ALMS_WEBUI = "(prdbug)1030 19:49 线下补录的单在贷后管理不显示详情" ;
	final String ALMS_WITHHOLD_SERVICE = "(prdbug)1108 16:50" ;
