...
window.layinit(function (htConfig) {
    ...
    vm = new Vue({
        ...
        data: {
            ...
            banks: [],
            upload: {
                url: coreBasePath + 'customerFirstDat/importCustomerFirstExcel',
            	//url: coreBasePath + 'camsSubject/initSubject',
                headers: {
...
let methods = {
    ...
    searchData() {
        ...
        axios.post(basePath + 'customerFirstDat/searchCustomerFirst', this.searchForm).then(res => {
