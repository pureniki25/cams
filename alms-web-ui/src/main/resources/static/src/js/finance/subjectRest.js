            ...
            table: {
                col: [
                    ...
                    },
                    {
                        ...
                        render: (h, params) => {
                            debugger
                            if (params.row.subject == '资产小计'||params.row.subject == '负债小计'
                            	||params.row.subject == '权益小计'||params.row.subject == '损益小计') {
                                return h('span', {
                                    style: {
                                        'font-weight': 'bold',
                        ...
                        sortable: true,
                        render: (h, params) => {
                            if (params.row.firstAmount.indexOf("-") != -1) {
                                return h('span', {
                                    style: {
                                        'font-weight': 'bold',
                        ...
                        sortable: true,
                        render: (h, params) => {
                            if (params.row.borrowAmount.indexOf("-") != -1) {
                                return h('span', {
                                    style: {
                                        'font-weight': 'bold',
                                        'background-color': '#FF9999'
                                ...
                                return h('span', {}, params.row.borrowAmount)
                            }
                        }
                    ...
                    },
                    {
                        ...
                        sortable: true,
                        render: (h, params) => {
                            if (params.row.almsAmount.indexOf("-") != -1) {
                                return h('span', {
                                    style: {
                                        'font-weight': 'bold',
                                        'background-color': '#FF9999'
                                ...
                                return h('span', {}, params.row.almsAmount)
                            }
                        }
                    }, {
                        title: '期末金额',
                        ...
                        sortable: true,
                        render: (h, params) => {
                            if (params.row.restAmount.indexOf("-") != -1) {
                                return h('span', {
                                    style: {
                                        'font-weight': 'bold',
                                        'background-color': '#FF9999'
...
let methods = {
    ...
    searchData() {
        ...
        axios.post(basePath + 'subjectRestDat/selectSubjectRest', this.searchForm).then(res => {
            self.table.loading = false;
            if (!!res.data && res.data.code == 0) {
                self.table.data = res.data.data;
                self.table.total = res.data.count;
