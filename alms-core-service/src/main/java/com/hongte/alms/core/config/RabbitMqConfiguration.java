...
public class RabbitMqConfiguration{
    ...
    @Primary
    public ConnectionFactory ucConnectionFactory(
            @Value("${spring.rabbitmq.hostuc.host}") String host,
...
//    @Primary
    public RabbitTemplate ucRabbitTemplate(
    ...
    public SimpleRabbitListenerContainerFactory ucSyncFactory(
