...
public class TdBorrowerPaymentDTO implements Serializable {
	...
	public String toString() {
		return "TdBorrowerPaymentDTO [principalAndInterest=" + principalAndInterest + ", tuandaiAmount=" + tuandaiAmount
				+ ", orgAmount=" + orgAmount + ", guaranteeAmount=" + guaranteeAmount + ", arbitrationAmount="
				+ arbitrationAmount + ", agencyAmount=" + agencyAmount + "]";
	}
