...
public class GeneratorUtil {
     ...
     * @return
     */
    public static DataSourceConfig setDataSorceConfig(String account, String pass, String dburl){
        return
     ...
     * @param table 多表用,隔开
     */
    public static void execute(GeneratorConfig config,DataSourceConfig dataSourceConfig,String table){
        {
            File file = new File(config.getProjectName());
            ...
            AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                    ...
                    .setStrategy(
                            ...
                            new StrategyConfig()
                                    ...
                                    // 自定义 mapper 父类
                                    .setSuperMapperClass("SuperMapper")
                                    // 自定义 service 父类
                                    ...
                                    // 自定义 mapper 父类
                                    .setSuperMapperClass(config.getSuperBasePackage()+".mapper.SuperMapper")
                                    // 自定义 service 父类
                                    .setSuperServiceClass(config.getSuperBasePackage()+".service.BaseService")
                                    // 自定义 service 实现类父类
                                    .setSuperServiceImplClass(config.getSuperBasePackage()+".service.impl.BaseServiceImpl")
                            ...
                            new PackageConfig()
                                    //.setModuleName("User")
                                    .setParent(config.getBasePackage()+config.getPackageName())// 自定义包路径
