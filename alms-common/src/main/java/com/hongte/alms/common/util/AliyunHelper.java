...
public class AliyunHelper {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(AliyunHelper.class);
	/**
	 * OSS操作对象
	 */
	...
	public void downObject(String downloadFile, String key, HttpServletResponse response) {
		try {
			// 创建OSSClient实例
			initOSSClient();
			...
			response.setHeader("Content-Disposition",
					"attachment;filename=" + URLEncoder.encode(downloadFile, "utf-8"));
