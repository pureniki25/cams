...
public class DateUtil {
	...
	public static List<Date> getWeekEndList(Integer year) {
		...
		while (DateUtil.getDiffDays(date, lastDate) > 0) {
			...
			if (6 == dayOfweek || 7 == dayOfweek) {
				// System.out.println(DateUtil.formatDate("yyyy-mMM-dd", date) + ":" +
				// dayOfweek);
	 ...
	 * 
	 * @param aMask
	 *            格式，为null时，按美国时间格式EEE MMM d HH:mm:ss z yyyy转换
	 * @param strDate
	 *            字符串
	 * @return
	 */
	 ...
	 * @return
	 */
	public static Date getLastFirstDate() {
		Calendar c = Calendar.getInstance();
	...
	public static void main(String[] args) {
		System.out.println(DateUtil.getLastFirstDate());
		System.out.println(DateUtil.getLastEndDate());
		System.out.println(DateUtil.getThisEndDate());
